import { EmeraldTitle, GrayTitle } from "@/components/reuseable";
...
export const SLOTS = [
  {
    label: "Mon 10:00 AM",
    cls: "border-emerald-400/30 text-emerald-200 bg-emerald-400/5",
  },
...
export const ROLES = [
  ...
  {
    label: "Interviewer",
    title: <EmeraldTitle>Earn doing what you&apos;re great at</EmeraldTitle>,
